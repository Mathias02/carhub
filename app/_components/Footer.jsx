...
<footer className="bg-white flex justify-center border-[1px]">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-12">
      <div className="mt-8 grid grid-cols-2 gap-16 lg:mt-0 lg:grid-cols-5 lg:gap-y-18">
          ...
          <form className="w-full">
            ...
            >
              <input
                ...
                className="w-full border-none sm:text-sm py-3 pl-2"
              />

              <button
                className="mt-1 w-full bg-primary px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-purple-900 sm:mt-0 sm:w-auto sm:shrink-0 rounded-md hover:text-blue-400"
              >
                Sign Up
              </button>
            </div>
