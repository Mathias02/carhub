    ...
    <div className='bg-slate-500 -z-10'>
        <div className='bg-gradient-to-tr from-blue-950 to-purple-300 h-92 relative'>
            ...
            <div className='flex flex-col justify-center items-center p-48'>
                ...
                <Link href={'/product'} className='relative cursor-pointer border bg-primary hover:bg-purple-950 hover:text-blue-400 text-white lg:px-7 py-3 px-6 lg:py-3 rounded-full lg:text-[18px] text-xl'> Browse my cars</Link>
            </div>     
